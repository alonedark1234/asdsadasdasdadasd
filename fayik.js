...
client1.on('ready',() => {
  ...
  client1.channels.cache.get("914479014628970516").join() 
  client1.user.setPresence({ activity: { name: 'Developed By Alone' }, status: 'dnd' })
});
...
client2.on('ready',() => {
  console.log("durum onlines!")
  client2.user.setPresence({ activity: { name: 'Developed By Alone' }, status: 'dnd' })
})
...
client2.on("ready", async () => {
client2.channels.cache.get("914479014628970516").join() 
...
client3.on("ready", async () => {
client3.channels.cache.get("914479014628970516").join() 
...
client3.on('ready',() => {
  console.log("durum onlines!")
  client3.user.setPresence({ activity: { name: 'Developed By Alone' }, status: 'dnd' })
})
